            ...
            <div className="services__container services grid">
                <div className="services__content">
                    ...
                    <i class="uil uil-web-grid services__icon"></i>
                        <h3 className="services__title">Product 
                        <br /> Designer</h3>
                    </div>
                    ...
                    <div className={toggleState === 1 ? "services__modal active-modal": "services__modal"}>
                        <div className="services__modal-content">
                            ...
                            <p className="services__modal-description">
                                Services more than 1 year Experince. 
                                Providing quality works to clients and 
                                compaines.
                            </p>
                            ...
                            <ul className="services__modal-services grid">
                                ...
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">Design and makeups of products for companies.</p>
                                </li>
